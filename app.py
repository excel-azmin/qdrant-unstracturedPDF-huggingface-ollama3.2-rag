...
# Contact Page
    ...
    - **Email:** [azmin@pixfar.com](mailto:azmin@pixfar.com) ✉️
    - **GitHub:** [Contribute on GitHub](https://github.com/excel-azmin/qdrant-unstracturedPDF-huggingface-ollama3.2-rag.git) 🛠️
...
# Footer
st.markdown("---")
st.markdown("© 2024 Document Buddy App by www.pixfar.com. All rights reserved. 🛡️")